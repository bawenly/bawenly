...
Для каждого шага отдельно рассчитай реалистичное время по его содержанию и ожидаемому результату. Не завышай простые действия, не занижай содержательную работу и не повторяй одну длительность механически.
