...
Строго соблюдай масштаб формулировки: «короткая», «небольшой» и «начать» означают компактный результат, а не полный большой проект. Не добавляй работу сверх результата, который запросил пользователь.
